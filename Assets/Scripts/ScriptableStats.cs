...
//also Tarodev for his movement

[CreateAssetMenu]
    public class ScriptableStats : ScriptableObject
    {
        [Header("INPUT KEYS")]
        [Tooltip("Set input keys for movement controlls")]
        ...
        [Tooltip("Time of flight")]
        public float KnockbackTime = .2f;

        [Tooltip("distance to fly")]
        public float KnockbackPower = 1f;


        [Tooltip("Air Knockback Multiplayer")]
        public float AirKnockbackMulti = 2f;
